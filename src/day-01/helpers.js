...
export function applyDirection (coordinates, direction, steps) {
  ...
  switch (direction) {
    case 'N': return [x, y + steps]
    case 'S': return [x, y - steps]
    case 'E': return [x + steps, y]
    case 'W': return [x - steps, y]
    default: throw Error(`Expected cardinal direction but received '${direction}'`)
  }
}
